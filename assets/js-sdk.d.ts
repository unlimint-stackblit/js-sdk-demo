...
declare class CardForm {
  constructor(options: {
    target: HTMLElement;
    props: Unlimint.JsSDK.CardFormProps;
  });
}

declare class PayForm {
  constructor(options: {
    target: HTMLElement;
    props: Unlimint.JsSDK.PayFormProps;
  });
}

declare class PayBySavedCardForm {
  constructor(options: {
    target: HTMLElement;
    props: Unlimint.JsSDK.PayBySavedCardFormProps;
  });
}
